...
from track.view import view_external_procurement
...
urlpatterns = [
    ...
    path('external-procurement-management/', view_external_procurement.external_procurement_management, name='external-procurement-management'),
    ...
    # API路由 - 外采产品管理
    path('api/external-procurement-products/', view_external_procurement.external_procurement_products_api, name='external-procurement-products'),
    path('api/external-procurement-products/<int:product_id>/', view_external_procurement.external_procurement_product_detail_api, name='external-procurement-product-detail'),
    path('api/external-procurement-products/batch-update/', view_external_procurement.batch_update_products, name='batch-update-products'),
    path('api/external-procurement-products/batch-delete/', view_external_procurement.batch_delete_products, name='batch-delete-products'),
]
